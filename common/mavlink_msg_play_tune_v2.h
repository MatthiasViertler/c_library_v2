...
typedef struct __mavlink_play_tune_v2_t {
 ...
 char tune[249]; /*<  Tune definition as a NULL-terminated string.*/
...
#define MAVLINK_MSG_ID_PLAY_TUNE_V2_CRC 246
#define MAVLINK_MSG_ID_400_CRC 246

#define MAVLINK_MSG_PLAY_TUNE_V2_FIELD_TUNE_LEN 249
...
#define MAVLINK_MESSAGE_INFO_PLAY_TUNE_V2 { \
    ...
    {  { "target_system", NULL, MAVLINK_TYPE_UINT8_T, 0, 4, offsetof(mavlink_play_tune_v2_t, target_system) }, \
         ...
         { "tune", NULL, MAVLINK_TYPE_CHAR, 249, 6, offsetof(mavlink_play_tune_v2_t, tune) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_PLAY_TUNE_V2 { \
                               ...
                               uint8_t target_system, uint8_t target_component, uint32_t format, const char *tune)
{
    ...
    _mav_put_char_array(buf, 6, tune, 249);
    ...
    mav_array_memcpy(packet.tune, tune, sizeof(char)*249);
...
{
    return _MAV_RETURN_char_array(msg, tune, 249,  6);
}
